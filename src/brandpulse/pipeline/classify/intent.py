"""Intent classification — Tier 5b enrichment, LLM-backed (Engineering Design §10)."""
...
INTENT_LABELS = ("Complaint", "Praise", "Query", "Warning", "Neutral")
PROMPT_VERSION = "v1"
...
def classify_intent(
    ...
    return run_llm_stage(
        ...
        stage="intent",
        prompt_name="enrichment_intent",
        prompt_version=PROMPT_VERSION,
        text=text,
        language=language,
        valid_labels=INTENT_LABELS,
